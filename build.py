...
updateJson=https://github.com/StimeKe/magisk-hluda/releases/latest/updater.json"""
...
def create_updater_json(project_tag: str):
    ...
    updater ={
        ...
        "zipUrl": f"https://github.com/ViRb3/magisk-hluda/releases/download/{project_tag}/MagiskHluda-{project_tag}.zip"
    }
