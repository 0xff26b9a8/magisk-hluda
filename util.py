...
# gets last tag of hluda
def get_last_hluda_tag() -> str:
    last_hluda_tag = get_last_github_tag('StimeKe/strongR-frida-android')
    print(f"Last hluda tag: {last_hluda_tag}")
    return last_hluda_tag
